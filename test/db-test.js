...
test('save image', async t => {
  ...
  t.is(created.url, image.url, 'retorna correctamente la url')
  t.is(created.likes, image.likes)
  t.is(created.liked, image.liked)
  t.is(created.description, image.description)
  t.deepEqual(created.tags, [ 'awesome', 'platzi', 'tags' ], 'crea correctamente las tags')
